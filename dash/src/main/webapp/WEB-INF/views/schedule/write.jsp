		...
		<form name="scheduleForm" method="post">
			<table class="table mt-5 write-form">
				<tr>
					...
					<td>
						...
						<small class="form-control-plaintext">* 제목은 필수입니다.</small>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<div class="row">
							<div class="col-5">
								<select name="color" id="form-color" class="form-select" style="height: 20px;">
			...
			<table class="table table-borderless">
					...
					<td class="text-center">
						<button type="button" class="btn btn-main" onclick="sendOk();">${mode=='update'?'수정':'등록'}&nbsp;<i class="bi bi-check2"></i></button>
						<button type="reset" class="btn btn-sub">다시입력</button>
						<button type="button" class="btn btn-sub" onclick="location.href='${pageContext.request.contextPath}/schedule/main';">${mode=='update'?'수정취소':'등록취소'}&nbsp;<i class="bi bi-x"></i></button>
