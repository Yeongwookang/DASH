...
<div class="row d-flex justify-content-center">
	...
	<div class="row mt-4 ms-2">
			<ul style="list-style: none" class="nav text-start mt-4 flex-column " >
				<li class="nav-item">
					<button class="btn nav-box" onclick="location.href='${pageContext.request.contextPath}/'"><i class="fa-regular fa-note-sticky"></i><span> 메인</span></button>
				</li>
				<li class="nav-item">
					<button class="btn nav-box" onclick="location.href='${pageContext.request.contextPath}/approval/main';"><i class="fa-regular fa-folder"></i><span> 결재</span></button>
				</li>
				<li class="nav-item">
					<button class="btn nav-box" onclick="#"><i class="fa-regular fa-note-sticky"></i><span> 공지</span></button>
				</li>
				<li class="nav-item">
					<button class="btn nav-box" onclick="location.href='${pageContext.request.contextPath}/insa/main'"><i class="bi bi-person-rolodex"></i><span> 인사</span></button>
				</li>
				<li>
				<div class="dropdown dropend nav-item">
					<button class="btn dropdown-toggle nav-box" type="button" id="kickboardMenu" data-bs-toggle="dropdown" aria-expanded="false">
						<i class="fa-solid fa-broom-ball"></i> 운영
					</button>	
