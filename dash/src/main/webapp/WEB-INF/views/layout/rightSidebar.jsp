...
function scheduleCount(){
	let url = "${pageContext.request.contextPath}/scheduleCount";
	
	const fn = function(data){
		let schcount = data.schcount;
		let selector = "#schcount";
		$(selector).html(schcount);
	};
...
<div id="sidebar" class="list-group mt-4">
		...
		<a class="list-group-item list-group-item-action d-flex justify-content-between align-items-center" aria-current="page" href="${pageContext.request.contextPath}/schedule/main">오늘 일정<span class="badge bg-main rounded-pill" id="schcount"></span></a>
