...
<div id="sidebar" class="list-group mt-5">
		<a class="list-group-item list-group-item-action d-flex justify-content-between align-items-center" aria-current="page" href="${pageContext.request.contextPath}/schedule/main">오늘 일정<span class="badge bg-main rounded-pill">${scdcount}</span></a>
