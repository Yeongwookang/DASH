...
<div id="sidebar" class="list-group mt-5">
		<a class="list-group-item list-group-item-action d-flex justify-content-between align-items-center" aria-current="page" href="${pageContext.request.contextPath}/message/receive/main">신규 쪽지<span class="badge bg-main rounded-pill">${sessionScope.employee.msgcount}</span></a>
